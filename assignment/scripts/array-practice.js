...
let favoriteFoods = ['beef stew', 'okonomiyaki', 'mapo tofu', 'onigiri', 'gyudon', 'congee'];
...
let lastAnimal = animalArray.indexOf('dog');
...
let lastAnimals = animalArray[animalArray.length - 1];
console.log(animalArray, lastAnimals);
...
let dessert = 'sticky toffee pudding';
